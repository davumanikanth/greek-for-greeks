<h2><a href="https://www.geeksforgeeks.org/problems/lower-case-to-upper-case3410/1?page=2&category=Strings&difficulty=Basic&status=unsolved&sortBy=latest">Lower case to upper case</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO" bis_skin_checked="1"><p><span style="font-size:18px">Given a string <strong>str </strong>containing only lowercase letters, generate a string with the same letters, but in uppercase.</span></p>
