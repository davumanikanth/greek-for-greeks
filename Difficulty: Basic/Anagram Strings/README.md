<h2><a href="https://www.geeksforgeeks.org/problems/java-anagram-strings3549/1?page=1&category=Strings&difficulty=Basic&status=unsolved&sortBy=latest">Anagram Strings</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO" bis_skin_checked="1"><p><span style="font-size: 18px;">Given two strings S1 and S2 . Return "1" if both strings are anagrams otherwise return "0" .</span></p>
