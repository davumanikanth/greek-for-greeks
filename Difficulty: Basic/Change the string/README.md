<h2><a href="https://www.geeksforgeeks.org/problems/change-the-string3541/1?page=3&category=Strings&difficulty=Basic&status=unsolved&sortBy=latest">Change the string</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO" bis_skin_checked="1"><p><span style="font-size: 18px;">Given a string <strong>s</strong>, the task is to change the complete string to uppercase or lowercase depending on the case of the first character.</span></p>
