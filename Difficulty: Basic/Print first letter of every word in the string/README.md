<h2><a href="https://www.geeksforgeeks.org/problems/print-first-letter-of-every-word-in-the-string3632/1?page=1&category=Strings&difficulty=Basic&status=unsolved&sortBy=latest">Print first letter of every word in the string</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO" bis_skin_checked="1"><div class="entry-content" bis_skin_checked="1">
